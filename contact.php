...
$conn_contact = mysqli_connect('localhost', 'root', '', 'contact');
        ...
        <div class="container">
            <div class="row mb-5">
                <div class="col-md-8 col-xl-6 text-center mx-auto">
                    <h2>Contact</h2>
                    <p>Contactați-ne pentru orice întrebări sau sugestii! Suntem aici pentru a vă ajuta și vom răspunde în cel mai scurt timp posibil.</p>
                </div>
            </div>
                    ...
                    <div class="d-flex flex-column justify-content-center align-items-start h-100">
                        ...
                        <div class="d-flex align-items-center p-3">
                            ...
                            <div class="px-2">
                                ...
                                <p class="mb-0">contact@elysium.com</p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center p-3">
                            ...
                            <div class="px-2">
                                ...
                                <p class="mb-0">6 Queen Verenikis Street Paphos, 8045, Cipru</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-5 col-xl-4">
                    <div>
                        <form class="p-3 p-xl-4" method="POST" action="">
                            ...
                            <div class="mb-3"><input class="form-control" type="text" id="name" name="name" placeholder="Name"></div><!-- End: Success Example -->
                            <!-- Start: Error Example -->
                            <div class="mb-3"><input class="form-control" type="email" id="email" name="email" placeholder="Email"></div><!-- End: Error Example -->
